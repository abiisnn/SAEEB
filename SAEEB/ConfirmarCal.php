...
";
	...
	if($con)
	{
		...
		$alumno = mysqli_query($con, "SELECT a.idAlumno, u.appaterno, a.idGrupo FROM usuario u, Alumno a, grupo g WHERE u.idUsuario=a.idAlumno AND a.idGrupo=g.idGrupo AND g.idGrupo='$grupo' ORDER BY u.ApPaterno, u.ApMaterno, u.nombre ASC;"); 
		$j = 0;
